...
from tests import _convert_entries2iter
                    ...
                    "output": [
                        {
                            ...
                            "summary": (
                                ...
                                " _ConversationRound init for unit test"
                                " injection, enabling custom iter_lines setup"
                            ),
                        },
                        {
                            "symbol": "^",
                            "summary": (
                                "add new test file conversation_round_test.py"
                                " with placeholder tests and initial stream"
                                " processing test for _ConversationRound"
                            ),
                        },
                    ]
                },
            ...
            "data": {
                ...
                "outputs": {
                    "text": (
                        ...
                        " wildflowers and listening to the songs of"
                        " birds.\n\nThe fairies welcomed Lily with smiles and"
                        " showed her their magical garden."
                    ),
                    "reasoning_content": "",
                    "usage": {
                        "prompt_tokens": 12,
    ...
    mock_resp.iter_lines.return_value = _convert_entries2iter([
        ...
        },
        {
            ...
            "data": {
                ...
                "outputs": {
                    "text": (
                        "Hello! I'm here to assist you with any questions or"
                        " tasks you have. Feel free to ask me anything!"
                    ),
                    "reasoning_content": "",
                    "usage": {
                        "prompt_tokens": 26,
    ...
    mock_resp.iter_lines.return_value = _convert_entries2iter([
        ...
        },
        {
            ...
            "data": {
                    ...
                    "prompts": [
                        ...
                        },
                        {
                            ...
                            "text": (
                                ...
                                " with the left child containing values less"
                                " than the parent, and the right child"
                                " containing values greater than the parent."
                                " The BST algorithm involves:\n\n1."
                                " **Insertion:** Starting at the root, compare"
                                " the new value with the current node; move"
                                " left if smaller, right if larger, until"
                                " reaching a None position, then insert the new"
                                " node.\n2. **Search:** Begin at the root,"
                                " compare the target value; traverse left or"
                                " right based on comparison, repeating until"
                                " the value is found or a None node is"
                                " reached.\n3. **Deletion:** Find the node to"
                                " delete; if it has no children, remove it; if"
                                " one child, replace it with its child; if two"
                                " children, replace it with its in-order"
                                " successor or predecessor, then delete that"
                                " node.\n\nBSTs support efficient average-case"
                                " operations like search, insert, and delete in"
                                " O(log n) time."
                            ),
                            "files": [],
                        },
                ...
                "outputs": {
                    "text": (
                        "BST algorithm:  \n- **Insert:** Compare value, go left"
                        " if smaller, right if larger, until None, insert node "
                        " \n- **Search:** Compare target, traverse left or"
                        " right, repeat until found or None  \n- **Delete:**"
                        " Remove node: no child (delete), one child (replace),"
                        " two children (replace with in-order"
