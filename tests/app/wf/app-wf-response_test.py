...
class TestNoStream:  # =========================================================
    ...
    def test_resp_obj(_, testee_no_stream, mock_chat_block_wf):
        mock_resp, _ = testee_no_stream
        assert mock_resp is mock_chat_block_wf
...
class TestStream:  # ===========================================================
    ...
    def test_resp_obj(_, testee_stream, mock_chat_block_wf):
