...
class TestCf1:  # ==============================================================
    ...
    def test_no_steam(_, pipe_obj, model_id_cf1, authorization_cf1):
    ...
    def test_steam(_, pipe_obj, model_id_cf1, authorization_cf1):
        model_id = model_id_cf1
        app = pipe_obj.apps[model_id]
        model = pipe_obj.models[model_id]
...
class TestCf2:  # ==============================================================
    ...
    def test_no_steam(_, pipe_obj, model_id_cf2, authorization_cf2):
    ...
    def test_steam(_, pipe_obj, model_id_cf2, authorization_cf2):
